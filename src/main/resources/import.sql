...
INSERT INTO roles (nombre) VALUE ("ROLE_USER");
INSERT INTO roles (nombre) VALUE ("ROLE_ADMIN");

INSERT INTO usuarios_role (usuarios_id, role_id) VALUE (1, 1);
INSERT INTO usuarios_role (usuarios_id, role_id) VALUE (2, 1);
INSERT INTO usuarios_role (usuarios_id, role_id) VALUE (2, 2);
